...
Dashboard.prototype.animateContainers = Common.prototype.animateContainers;
Dashboard.prototype.$ = Common.prototype.$;
Dashboard.prototype.myGet = Common.prototype.myGet;
Dashboard.prototype.loadKeygroup = Common.prototype.loadKeyGroup;
Dashboard.prototype.resetKeygroup = Common.prototype.resetKeyGroup;
Dashboard.prototype.downloadKeylist = Common.prototype.downloadKeylist;
Dashboard.prototype.uploadKeylist = Common.prototype.uploadKeylist;
Dashboard.prototype.updateGroupList = Common.prototype.updateGroupList;
Dashboard.prototype.addKeyGroupListeners = Common.prototype.addKeyGroupListeners;

Dashboard.prototype.datetimeIntervalPicker = Common.prototype.datetimeIntervalPicker;

Dashboard.prototype.excelExport = Common.prototype.excelExport;
Dashboard.prototype.addExportButton = Common.prototype.addExportButton;
...
Dashboard.prototype.resume = function() {
    subModule.parent = this.$('.packery');
};



Dashboard.prototype.prepareDOM = function() {
    var This = this;
    ...
    this.subModules = [
        ...
        new subModule({
            ...
            data: [],
            type: 'dataTable',
            columns: [{text: 'URL', tag: '<a>'}, {text: 'Hits'}],
            options: {
                mode: 'top_url',
                size: 10,
                export: true,
        ...
        new subModule({
            title: lang_array['hashtag_cloud'],
            resize: 'es',
            default: '22',
            data: [],
            type: 'wordCloud',
...
Dashboard.prototype.createXLSData = function() {
...
Dashboard.prototype.request = function() {
    var This = this;
    for (var i = 0; i < this.subModules.length; i++) {
