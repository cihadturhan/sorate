$(function(d1, t1, d2, t2) {
    var DATEPICKER_FORMAT = 'd m yyyy';
    var TIMEPICKER_FORMAT = 'G:i';
    var DATE_FORMAT = 'j F Y'; // for this format see http://php.net/manual/function.date.php
    ...
    $.each([t1, t2], function() {
        ...
        if ($this.hasClass('end')) {
            $this.on('focus', function() {
                $('.ui-timepicker-with-duration').scrollTop(0);
            });
        }
