            ...
            var newList = {
                ...
                dragStart: function(e) {
                    ...
                    list.scroll.scrollY = window.setInterval(function() {
                        if (!opts.scrollContainer.is($(window))) {
                ...
                setPos: function(x, y) {
                    ...
                    this.draggedItem.parents().each(function() {
                        if ($(this).css("position") != "static" && ($.browser && !$.browser.mozilla || $(this).css("display") != "table")) {
                    ...
                    if (opts.scrollContainer.is($(window))) {
                        ...
                        y = Math.max(0, y - cont.height() - offset.top + this.draggedItem.outerHeight()/2) + Math.min(0, y - offset.top);
                        x = Math.max(0, x - cont.width() - offset.left + this.draggedItem.outerWidth()/2) + Math.min(0, x - offset.left);
                    }
                ...
                wheel: function(e) {
                    if (($.browser && $.browser.safari || $.browser.mozilla) && list && !opts.scrollContainer.is($(window))) {
                        var cont = opts.scrollContainer;
                        var offset = cont.offset();
                        if (e.pageX > offset.left && e.pageX < offset.left && e.pageY > offset.top && e.pageY < offset.top ) {
